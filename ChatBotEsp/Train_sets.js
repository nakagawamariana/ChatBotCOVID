...
var {natural, tokenizer, Tokenize, stemmer, Stemming, Bag_of_words, Bag_of_words_t, Bag_nostem, Bag_of_words_t_n} = require("./Functions_NLP.js")
...
for (element of vocabulary_ca.xy_ca){
    ...
    bag = Bag_of_words_t_n(pattern, vocabulary_ca.v_ca);
